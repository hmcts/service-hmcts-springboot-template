...
The application uses port `4550` by default. You can override this using any of the following methods:
...
```bash
# Solution: Find and kill process using port 4550
lsof -ti:4550 | xargs kill -9
